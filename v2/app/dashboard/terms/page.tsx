    ...
    <div className="max-w-4xl mx-auto px-6 py-12 font-sans">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-10 lg:p-16 shadow-sm space-y-12">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section className="space-y-4 text-sm font-medium text-slate-600 leading-relaxed">
            <h2 className="text-lg font-bold text-slate-900">2. Professional Conduct</h2>
            <p>Users are expected to maintain professional standards in all interactions. The platform is designed for networking, career growth, and institutional collaboration.</p>
          </section>

          <section className="space-y-4 text-sm font-medium text-slate-600 leading-relaxed">
            <h2 className="text-lg font-bold text-slate-900">3. Verified Identity</h2>
            <p>Identity verification is mandatory. Any attempt to misrepresent institutional status or achievements will result in immediate suspension of access.</p>
          </section>
        </div>

        <div className="pt-10 border-t border-slate-100 flex items-center justify-between">
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic">Updated March 2026</p>
          <div className="px-4 py-2 bg-slate-50 rounded-lg text-[9px] font-black text-slate-400 uppercase tracking-widest">Institutional Version 1.0</div>
        </div>
      </div>
    </div>
  );
