...
class User {
    ...
    public function updateProfile(int $id, array $fields): bool {
        $allowed = ['name', 'current_job', 'designation', 'company', 'location_city', 'location_country', 'bio', 'skills', 'interests', 'linkedin', 'github', 'instagram', 'facebook', 'twitter', 'website', 'resume', 'resume_visibility', 'profile_visibility', 'cover_photo', 'profile_photo'];
        $set = [];
        $values = [];
